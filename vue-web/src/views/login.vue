<style scoped>
    ...
    /*具体内容*/
    .wrap_conter ul{position:relative;width:300px;border-radius:5px;background: #fff;margin: 0 auto;}
                            ...
                            <dl>
                                ...
                                <FormItem>
                                    ...
                                    <div style="width: 250px">
                                        <a href="https://github.com/login/oauth/authorize?client_id=c897b669c9ff6baf0abb" style="{right: 26px;}">
