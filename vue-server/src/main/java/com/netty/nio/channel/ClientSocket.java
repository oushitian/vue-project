...
/**
 * @Author xyl
 * @Create 2018-11-07 10:20
 * @Desc 写点注释吧
 **/
public class ClientSocket {

    public static class TCPClients implements Runnable{
        ...
        public TCPClients(String name, InetSocketAddress remoteAddress) {
            this.name = name;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread ta = new Thread(new TCPClients("thread a", remoteAddress));
        Thread tb = new Thread(new TCPClients("thread b", remoteAddress));
        Thread tc = new Thread(new TCPClients("thread c", remoteAddress));
